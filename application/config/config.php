...
|
*/
$config['base_url'] = $root = "http://".$_SERVER['HTTP_HOST'].str_replace(basename($_SERVER['SCRIPT_NAME']),"",$_SERVER['SCRIPT_NAME']);
...
|
*/
$config['encryption_key'] = '821sdf115DGF654e1rg54D45gr84134e888WWW88Rg888';
